...
After user confirms, the ingestion report feeds into either `/gfr-design-story` or `/ux-requirements-synthesizer` depending on the workflow:

| Ingestion output | gfr-design-story section | ux-requirements-synthesizer section |
|---|---|---|
| Component names / props | Section 4 — Component Spec | Component Spec |
| Layout structure | Section 3 — Screen Inventory | Screen Inventory |
| Copy inventory | Section 7 — Copy & Tone Notes | Copy & Tone Notes |
| Implied interactions | Section 5 — Interaction & State Map | Interaction & State Map |
| Unresolved items | Section 9 — Ambiguity & Decision Log | Ambiguity Log |

**Use `/gfr-design-story`** when the designer needs a full working document before design begins — problem framing, user stories, data contract, and decision log included.

**Use `/ux-requirements-synthesizer`** when the goal is a v0-ready spec or prototype brief directly.
